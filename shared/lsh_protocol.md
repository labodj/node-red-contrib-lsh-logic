...
- Spec revision: `2026050101`
- Wire protocol major: `3`
- Revision note: Metadata-only revision. Never transmitted on wire.
...
The protocol assumes a trusted environment and a cooperative broker. Protect the transport instead: use MQTT users and ACLs, TLS, network isolation, serial trust boundaries, and host controls. LSH payloads do not carry their own authentication, integrity, or confidentiality layer.
